...
var postcssLoader = {
  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (supportModules) {
        plugins.unshift(require('postcss-modules')(_objectSpread(_objectSpread({
          // In tests
      ...
      const postcssOptions = _objectSpread(_objectSpread(_objectSpread({}, _this.options.postcss), config.options), {}, {
...
var sassLoader = {
  ...
  process({
    ...
    return new Promise((resolve$$1, reject) => {
      ...
      return workQueue.add(() => render(_objectSpread(_objectSpread({}, this.options), {}, {
        file: this.id,
        data: data + code,
...
var stylusLoader = {
  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      const style = stylus(code, _objectSpread(_objectSpread({}, _this.options), {}, {
        filename: _this.id,
...
var lessLoader = {
  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      let _ref = yield pify(less.render.bind(less))(code, _objectSpread(_objectSpread({}, _this.options), {}, {
        sourceMap: _this.sourceMap && {},
        filename: _this.id
      })),
          css = _ref.css,
...
class Loaders {
  constructor(options = {}) {
    ...
    const customPostcssLoader = _objectSpread(_objectSpread({}, postcssLoader), {}, {
...
var index = ((options = {}) => {
  ...
  return {
    ...
    augmentChunkHash() {
      ...
      const extractedValue = [...extracted].reduce((object, [key, value]) => _objectSpread(_objectSpread({}, object), {}, {
        [key]: value
      }), {});
